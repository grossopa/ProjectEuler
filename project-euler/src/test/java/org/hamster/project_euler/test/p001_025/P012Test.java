...
import org.hamster.project_euler.p001_025.P012;
 ...
 * @since 1.0
 */
public class P012Test extends AbstractSolutionTest<P012> {
    ...
    protected TestResult solution() {
        return TestResult.create(500, 76576500);
    }
     ...
     */
    @Override
    protected Class<P012> problemClass() {
        return P012.class;
    }
