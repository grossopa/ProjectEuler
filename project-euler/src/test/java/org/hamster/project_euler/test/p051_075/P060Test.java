...
import org.hamster.project_euler.p051_075.P060;
 ...
 * @version 1.0
 */
public class P060Test extends AbstractSolutionTest<P060> {
    ...
    protected TestResult example() {
        return TestResult.create(4, 792);
    }
    ...
    protected TestResult solution() {
        return TestResult.create(5, 26033);
    }
     ...
     */
    @Override
    protected Class<P060> problemClass() {
        return P060.class;
    }
