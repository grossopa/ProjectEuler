...
import org.hamster.project_euler.p001_025.P016;
 ...
 * @since 1.0
 */
public class P016Test extends AbstractSolutionTest<P016> {
    ...
    protected TestResult example() {
        return TestResult.create(15, 26);
    }
    ...
    protected TestResult solution() {
        return TestResult.create(1000, 1366);
    }
     ...
     */
    @Override
    protected Class<P016> problemClass() {
        return P016.class;
    }
