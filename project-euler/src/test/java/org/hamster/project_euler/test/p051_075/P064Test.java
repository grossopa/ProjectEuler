 ...
 * @version 1.0
 */
public class P064Test extends AbstractSolutionTest<P064> {
    ...
    protected TestResult solution() {
        return TestResult.create(10000, 1322);
    }
     ...
     */
    @Override
    protected Class<P064> problemClass() {
        return P064.class;
    }
