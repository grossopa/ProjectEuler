...
import org.hamster.project_euler.p026_050.P048;
 ...
 * @version 1.0
 */
public class P048Test extends AbstractSolutionTest<P048> {
    ...
    protected TestResult example() {
        return TestResult.create(10, 405071317);
    }
    ...
    protected TestResult solution() {
        return TestResult.create(1000, 9110846700L);
    }
     ...
     */
    @Override
    protected Class<P048> problemClass() {
        return P048.class;
    }
