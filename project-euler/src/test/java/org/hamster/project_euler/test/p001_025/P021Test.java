...
import org.hamster.project_euler.p001_025.P021;
 ...
 * @version 1.0
 */
public class P021Test extends AbstractSolutionTest<P021> {
    ...
    protected TestResult solution() {
        return TestResult.create(10000, 31626);
    }
     ...
     */
    @Override
    protected Class<P021> problemClass() {
        return P021.class;
    }
