...
import org.hamster.project_euler.p026_050.P030;
 ...
 * @since 1.0
 */
public class P030Test extends AbstractSolutionTest<P030> {
    ...
    protected TestResult example() {
        return TestResult.create(4, 19316);
    }
    ...
    protected TestResult solution() {
        return TestResult.create(5, 443839);
    }
     ...
     */
    @Override
    protected Class<P030> problemClass() {
        return P030.class;
    }
