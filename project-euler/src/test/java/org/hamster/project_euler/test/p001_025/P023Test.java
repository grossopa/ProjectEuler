...
import org.hamster.project_euler.p001_025.P023;
 ...
 * @version 1.0
 */
public class P023Test extends AbstractSolutionTest<P023> {
    ...
    protected TestResult solution() {
        return TestResult.create(0, 4179871);
    }
     ...
     */
    @Override
    protected Class<P023> problemClass() {
        return P023.class;
    }
