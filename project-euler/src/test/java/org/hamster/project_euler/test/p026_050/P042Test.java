...
import org.hamster.project_euler.p026_050.P042;
 ...
 * @version 1.0
 */
public class P042Test extends AbstractSolutionTest<P042> {
    ...
    protected TestResult solution() {
        return TestResult.create(0, 162);
    }
     ...
     */
    @Override
    protected Class<P042> problemClass() {
        return P042.class;
    }
