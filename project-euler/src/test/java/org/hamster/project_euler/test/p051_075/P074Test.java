...
import org.hamster.project_euler.p051_075.P074;
 ...
 * @version 1.0
 */
public class P074Test extends AbstractSolutionTest<P074> {
    ...
    protected TestResult solution() {
        return TestResult.create(1_000_000, 402);
    }
     ...
     */
    @Override
    protected Class<P074> problemClass() {
        return P074.class;
    }
