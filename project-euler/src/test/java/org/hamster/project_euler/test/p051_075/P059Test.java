...
import org.hamster.project_euler.p051_075.P059;
 ...
 * @since 1.0
 */
public class P059Test extends AbstractSolutionTest<P059> {
    ...
    protected TestResult solution() {
        return TestResult.create(0, 107359);
    }
     ...
     */
    @Override
    protected Class<P059> problemClass() {
        return P059.class;
    }
