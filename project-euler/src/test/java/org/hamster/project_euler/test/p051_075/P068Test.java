...
import org.hamster.project_euler.p051_075.P068;
 ...
 * @version 1.0
 */
public class P068Test extends AbstractSolutionTest<P068> {
    ...
    protected TestResult example() {
        // return TestResult.create(3, 432621513L);
        return null;
    }
     ...
     */
    @Override
    protected Class<P068> problemClass() {
        return P068.class;
    }
