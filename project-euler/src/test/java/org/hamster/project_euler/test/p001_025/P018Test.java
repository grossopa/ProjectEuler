...
import org.hamster.project_euler.p001_025.P018;
 ...
 * @version 1.0
 */
public class P018Test extends AbstractSolutionTest<P018> {
    ...
    protected TestResult solution() {
        return TestResult.create(0, 1074);
    }
     ...
     */
    @Override
    protected Class<P018> problemClass() {
        return P018.class;
    }
