...
import org.hamster.project_euler.p051_075.P058;
 ...
 * @version 1.0
 */
public class P058Test extends AbstractSolutionTest<P058> {
    ...
    protected TestResult solution() {
        return TestResult.create(0, 26241);
    }
     ...
     */
    @Override
    protected Class<P058> problemClass() {
        return P058.class;
    }
