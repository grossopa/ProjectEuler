...
import org.hamster.project_euler.p026_050.P035;
 ...
 * @version 1.0
 */
public class P035Test extends AbstractSolutionTest<P035> {
    ...
    protected TestResult example() {
        return TestResult.create(100, 13);
    }
    ...
    protected TestResult solution() {
        return TestResult.create(1_000_000, 55);
    }
     ...
     */
    @Override
    protected Class<P035> problemClass() {
        return P035.class;
    }
