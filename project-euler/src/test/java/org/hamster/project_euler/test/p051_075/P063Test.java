...
import org.hamster.project_euler.p051_075.P063;
 ...
 * @version 1.0
 */
public class P063Test extends AbstractSolutionTest<P063> {
     ...
     */
    @Override
    protected Class<P063> problemClass() {
        return P063.class;
    }
